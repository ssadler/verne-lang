...
(function(exports) {
  ...
  exports["compactShow"] = $foreign.compactShow;;
...
(function(exports) {
  ...
  var LIST_T = (function () {
      function LIST_T(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      LIST_T.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new LIST_T(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var ATOM_T = (function () {
      function ATOM_T(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      ATOM_T.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new ATOM_T(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var genericParseResult = function (__dict_Generic_8) {
      return new Data_Generic.Generic(function ($dollarx) {
          if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.Success" && $dollarx.value1.length === 1)) {
              return Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Success.create))(Data_Generic.fromSpine(__dict_Generic_8)($dollarx.value1[0](Prelude.unit)));
          };
          if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.Partial" && $dollarx.value1.length === 1)) {
              return Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Partial.create))(Data_Generic.fromSpine(__dict_Generic_8)($dollarx.value1[0](Prelude.unit)));
          };
          ...
          if ($dollarx instanceof Success) {
              return new Data_Generic.SProd("Language.Verne.Types.Success", [ function ($dollarq) {
                  return Data_Generic.toSpine(__dict_Generic_8)($dollarx.value0);
              } ]);
          };
          ...
          throw new Error("Failed pattern match at Language.Verne.Types line 59, column 1 - line 60, column 1: " + [ $dollarx.constructor.name ]);
      });
  };
  ...
  var genericLISP = function (__dict_Generic_10) {
      return function (__dict_Generic_11) {
          return new Data_Generic.Generic(function ($dollarx) {
              if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.LIST" && $dollarx.value1.length === 2)) {
                  return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(LIST.create))(Data_Generic.fromSpine(__dict_Generic_10)($dollarx.value1[0](Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericArray(genericLISP(__dict_Generic_10)(__dict_Generic_11)))($dollarx.value1[1](Prelude.unit)));
              };
              if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.ATOM" && $dollarx.value1.length === 2)) {
                  return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(ATOM.create))(Data_Generic.fromSpine(__dict_Generic_10)($dollarx.value1[0](Prelude.unit))))(Data_Generic.fromSpine(__dict_Generic_11)($dollarx.value1[1](Prelude.unit)));
              };
              return Data_Maybe.Nothing.value;
          }, function ($dollarq) {
              return new Data_Generic.SigProd("Language.Verne.Types.LISP", [ {
                  ...
                  sigValues: [ function ($dollarq_1) {
                      return Data_Generic.toSignature(__dict_Generic_11)(Data_Generic.anyProxy);
                  }, function ($dollarq_1) {
                      return Data_Generic.toSignature(Data_Generic.genericArray(genericLISP(__dict_Generic_11)(__dict_Generic_10)))(Data_Generic.anyProxy);
                  } ]
              }, {
                  ...
                  sigValues: [ function ($dollarq_1) {
                      ...
                      return Data_Generic.toSignature(__dict_Generic_10)(Data_Generic.anyProxy);
                  } ]
              } ]);
          }, function ($dollarx) {
              if ($dollarx instanceof LIST) {
                  return new Data_Generic.SProd("Language.Verne.Types.LIST", [ function ($dollarq) {
                      return Data_Generic.toSpine(__dict_Generic_10)($dollarx.value0);
                  }, function ($dollarq) {
                      return Data_Generic.toSpine(Data_Generic.genericArray(genericLISP(__dict_Generic_10)(__dict_Generic_11)))($dollarx.value1);
                  } ]);
              };
              if ($dollarx instanceof ATOM) {
                  return new Data_Generic.SProd("Language.Verne.Types.ATOM", [ function ($dollarq) {
                      ...
                      return Data_Generic.toSpine(__dict_Generic_11)($dollarx.value1);
                  } ]);
              };
  ...
  var showLISP = function (__dict_Show_4) {
      return function (__dict_Show_5) {
          return function (__dict_Generic_6) {
              return function (__dict_Generic_7) {
                  return new Prelude.Show(Data_Generic.gShow(genericLISP(__dict_Generic_6)(__dict_Generic_7)));
              };
          };
      };
  };
  var genericComponent = new Data_Generic.Generic(function ($dollarx) {
      if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.Component" && $dollarx.value1.length === 1)) {
          return Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Component))((function (r) {
              if (r instanceof Data_Generic.SRecord && r.value0.length === 3) {
                  return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(function (name_1) {
                      return function (original_1) {
                          return function (signature_1) {
                              return {
                                  name: name_1, 
                                  original: original_1, 
                  ...
                  }))(Data_Generic.fromSpine(Data_Generic.genericString)((r.value0[0]).recValue(Prelude.unit))))((function (r_1) {
                      if (r_1 instanceof Data_Generic.SRecord && r_1.value0.length === 0) {
                          return new Data_Maybe.Just({});
                      };
                      return Data_Maybe.Nothing.value;
                  })((r.value0[1]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericArray(Data_Generic.genericString))((r.value0[2]).recValue(Prelude.unit)));
              };
              return Data_Maybe.Nothing.value;
      ...
      return new Data_Generic.SigProd("Language.Verne.Types.Component", [ {
          sigConstructor: "Language.Verne.Types.Component", 
          sigValues: [ function ($dollarq_1) {
      ...
      return new Data_Generic.SProd("Language.Verne.Types.Component", [ function ($dollarq) {
          return new Data_Generic.SRecord([ {
              recLabel: "name", 
              recValue: function ($dollarq_1) {
                  return Data_Generic.toSpine(Data_Generic.genericString)($dollarx.name);
              }
          }, {
              recLabel: "original", 
              recValue: function ($dollarq_1) {
              ...
              recLabel: "signature", 
              recValue: function ($dollarq_1) {
                  return Data_Generic.toSpine(Data_Generic.genericArray(Data_Generic.genericString))($dollarx.signature);
              }
          } ]);
      } ]);
  });
  var genericLISP_T = function (__dict_Generic_9) {
      return new Data_Generic.Generic(function ($dollarx) {
          if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.LIST_T" && $dollarx.value1.length === 4)) {
              return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(LIST_T.create))(Data_Generic.fromSpine(Data_Generic.genericString)($dollarx.value1[0](Prelude.unit))))(Data_Generic.fromSpine(genericPos)($dollarx.value1[1](Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericMaybe(Data_Generic.genericString))($dollarx.value1[2](Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericArray(genericLISP_T(__dict_Generic_9)))($dollarx.value1[3](Prelude.unit)));
          };
          if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.ATOM_T" && $dollarx.value1.length === 4)) {
              return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(ATOM_T.create))(Data_Generic.fromSpine(Data_Generic.genericString)($dollarx.value1[0](Prelude.unit))))(Data_Generic.fromSpine(genericPos)($dollarx.value1[1](Prelude.unit))))(Data_Generic.fromSpine(__dict_Generic_9)($dollarx.value1[2](Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericEither(Data_Generic.genericString)(genericComponent))($dollarx.value1[3](Prelude.unit)));
          };
          return Data_Maybe.Nothing.value;
      }, function ($dollarq) {
          return new Data_Generic.SigProd("Language.Verne.Types.LISP_T", [ {
              sigConstructor: "Language.Verne.Types.LIST_T", 
              sigValues: [ function ($dollarq_1) {
                  return Data_Generic.toSignature(Data_Generic.genericString)(Data_Generic.anyProxy);
              }, function ($dollarq_1) {
                  ...
                  return Data_Generic.toSignature(Data_Generic.genericArray(genericLISP_T(__dict_Generic_9)))(Data_Generic.anyProxy);
              } ]
          }, {
              sigConstructor: "Language.Verne.Types.ATOM_T", 
              sigValues: [ function ($dollarq_1) {
                  return Data_Generic.toSignature(Data_Generic.genericString)(Data_Generic.anyProxy);
              }, function ($dollarq_1) {
                  return Data_Generic.toSignature(genericPos)(Data_Generic.anyProxy);
              }, function ($dollarq_1) {
                  return Data_Generic.toSignature(__dict_Generic_9)(Data_Generic.anyProxy);
              }, function ($dollarq_1) {
                  return Data_Generic.toSignature(Data_Generic.genericEither(Data_Generic.genericString)(genericComponent))(Data_Generic.anyProxy);
              } ]
          } ]);
      }, function ($dollarx) {
          if ($dollarx instanceof LIST_T) {
              return new Data_Generic.SProd("Language.Verne.Types.LIST_T", [ function ($dollarq) {
                  return Data_Generic.toSpine(Data_Generic.genericString)($dollarx.value0);
              }, function ($dollarq) {
                  return Data_Generic.toSpine(genericPos)($dollarx.value1);
              }, function ($dollarq) {
                  return Data_Generic.toSpine(Data_Generic.genericMaybe(Data_Generic.genericString))($dollarx.value2);
              }, function ($dollarq) {
                  return Data_Generic.toSpine(Data_Generic.genericArray(genericLISP_T(__dict_Generic_9)))($dollarx.value3);
              } ]);
          };
          if ($dollarx instanceof ATOM_T) {
              return new Data_Generic.SProd("Language.Verne.Types.ATOM_T", [ function ($dollarq) {
                  return Data_Generic.toSpine(Data_Generic.genericString)($dollarx.value0);
              }, function ($dollarq) {
                  return Data_Generic.toSpine(genericPos)($dollarx.value1);
              }, function ($dollarq) {
                  return Data_Generic.toSpine(__dict_Generic_9)($dollarx.value2);
              }, function ($dollarq) {
                  return Data_Generic.toSpine(Data_Generic.genericEither(Data_Generic.genericString)(genericComponent))($dollarx.value3);
              } ]);
          };
          throw new Error("Failed pattern match: " + [ $dollarx.constructor.name ]);
      });
  };
  var showLISP_T = function (__dict_Generic_2) {
      return function (__dict_Show_3) {
          return new Prelude.Show(function (_133) {
              return Language_Verne_Utils.compactShow(Data_Generic.gShow(genericLISP_T(__dict_Generic_2))(_133));
          });
      };
  };
  var genericAtom = new Data_Generic.Generic(function ($dollarx) {
      ...
      throw new Error("Failed pattern match at Language.Verne.Types line 53, column 1 - line 54, column 1: " + [ $dollarx.constructor.name ]);
  });
  var showAtom = new Prelude.Show(Data_Generic.gShow(genericAtom));
  var eqPos = new Prelude.Eq(Data_Generic.gEq(genericPos));
  var eqParseResult = function (__dict_Eq_12) {
      return function (__dict_Generic_13) {
          return new Prelude.Eq(Data_Generic.gEq(genericParseResult(__dict_Generic_13)));
      };
  };
  var eqLISP_T = function (__dict_Generic_14) {
      return function (__dict_Eq_15) {
          return new Prelude.Eq(Data_Generic.gEq(genericLISP_T(__dict_Generic_14)));
      };
  };
  var eqLISP = function (__dict_Eq_16) {
      return function (__dict_Eq_17) {
          return function (__dict_Generic_18) {
              return function (__dict_Generic_19) {
                  return new Prelude.Eq(Data_Generic.gEq(genericLISP(__dict_Generic_18)(__dict_Generic_19)));
              };
          };
      };
  };
  ...
  var componentIsForeign = new Data_Foreign_Class.IsForeign(function (fo) {
      return Prelude["<$>"](Data_Either.functorEither)(Component)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(function (_0) {
          return function (_1) {
              return function (_2) {
                  return {
                      name: _0, 
      ...
      })(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("name")(fo)))(Data_Foreign_Class.readProp(Data_Foreign_Class.arrayIsForeign(Data_Foreign_Class.stringIsForeign))(Data_Foreign_Index.indexString)("signature")(fo)))(Prelude.pure(Data_Either.applicativeEither)(Data_Foreign.unsafeFromForeign(fo))));
  });
  exports["Pos"] = Pos;
  ...
  exports["genericLISP_T"] = genericLISP_T;
...
(function(exports) {
  ...
  var addComponent$prime = function (_2) {
      return function (_3) {
          ...
          throw new Error("Failed pattern match at Language.Verne.Namespace line 43, column 1 - line 44, column 1: " + [ _14.constructor.name ]);
      };
  };
  var addComponent = function (f) {
      return function (ns) {
          ...
          throw new Error("Failed pattern match at Language.Verne.Namespace line 36, column 1 - line 37, column 1: " + [ _17.constructor.name ]);
      };
  };
      ...
      return function (close) {
          return function (p) {
              return Prelude.bind(Text_Parsing_StringParser.bindParser)(open)(function () {
                  return Prelude.bind(Text_Parsing_StringParser.bindParser)(p)(function (_2) {
...
(function(exports) {
  ...
  var parseStr = (function () {
      var str = Text_Parsing_StringParser_Combinators.many(Text_Parsing_StringParser_String.satisfy(function (_40) {
          return !(function (_0) {
              return Prelude["=="](Prelude.eqChar)(_0)("\"");
          })(_40);
      }));
      var lit = Text_Parsing_StringParser_Combinators.between(Text_Parsing_StringParser_String["char"]("\""))(Text_Parsing_StringParser_String["char"]("\""))(str);
      return Prelude["<$>"](Text_Parsing_StringParser.functorParser)(Prelude["<$>"](Prelude.functorFn)(Language_Verne_Types.Str.create)(function (_41) {
          return Data_String.fromCharArray(Data_List.fromList(Data_Unfoldable.unfoldableArray)(_41));
      }))(lit);
  })();
  var parseName = (function () {
      ...
      return Prelude.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_String.lowerCaseChar)(function (_4) {
          return Prelude.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_Combinators.many(myAlphaNum))(function (_3) {
              return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(Language_Verne_Types.Name.create(Data_String.fromCharArray(Data_List.fromList(Data_Unfoldable.unfoldableArray)(new Data_List.Cons(_4, _3)))));
          });
      });
  })();
  var getPos = new Text_Parsing_StringParser.Parser(function (_9) {
      return function (_8) {
          return function (sc) {
              return sc(_9.pos)(_9);
          };
  ...
  var codePos = function (p) {
      return Prelude.bind(Text_Parsing_StringParser.bindParser)(getPos)(function (_7) {
          return Prelude.bind(Text_Parsing_StringParser.bindParser)(p)(function (_6) {
              return Prelude.bind(Text_Parsing_StringParser.bindParser)(getPos)(function (_5) {
                  return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(_6(new Language_Verne_Types.Pos(_7, _5)));
              });
          });
      });
  };
  var parseArgs = Text_Parsing_StringParser_Combinators.fix(function (_10) {
  ...
  var parseArg = (function () {
      var parseParens = Text_Parsing_StringParser_Combinators.fix(function (_11) {
          return Prelude.bind(Text_Parsing_StringParser.bindParser)(Control_Apply["<*"](Text_Parsing_StringParser.applyParser)(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_String["char"]("("))(Text_Parsing_StringParser_String.skipSpaces))(parseArgs))(Text_Parsing_StringParser_Combinators.optional(Text_Parsing_StringParser_String["char"](")"))))(function (_1) {
              return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(Prelude.flip(Language_Verne_Types.LIST.create)(_1));
          });
      });
      var parseAtom = Prelude.bind(Text_Parsing_StringParser.bindParser)(Control_Alt["<|>"](Text_Parsing_StringParser.altParser)(parseStr)(parseName))(function (_2) {
          return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(Prelude.flip(Language_Verne_Types.ATOM.create)(_2));
      });
      return codePos(Control_Alt["<|>"](Text_Parsing_StringParser.altParser)(parseAtom)(parseParens));
  })();
  var checkSuccess = function (a) {
      return function (_12) {
          var dive = function (__copy__14) {
              var _14 = __copy__14;
              tco: while (true) {
                  if (_14 instanceof Language_Verne_Types.LIST) {
                      var _28 = Data_Array.last(_14.value1);
                      ...
                      throw new Error("Failed pattern match at Language.Verne.Parser line 77, column 1 - line 78, column 1: " + [ _28.constructor.name ]);
                  };
                  if (_14 instanceof Language_Verne_Types.ATOM && _14.value1 instanceof Language_Verne_Types.Catch) {
                      return new Language_Verne_Types.Partial(a);
                  };
                  if (_14 instanceof Language_Verne_Types.ATOM) {
                      return new Language_Verne_Types.Success(a);
                  };
                  throw new Error("Failed pattern match at Language.Verne.Parser line 77, column 1 - line 78, column 1: " + [ _14.constructor.name ]);
              };
          };
          return dive(a);
      };
  ...
  var parse = function (input) {
      ...
      var onErr = function (pos) {
          return function (_13) {
              if (_13 instanceof Text_Parsing_StringParser.ParseError) {
                  return new Language_Verne_Types.Failure(pos, _13.value0);
              };
              if (_13 instanceof Text_Parsing_StringParser.EndOfInput) {
                  return new Language_Verne_Types.Failure(pos, "EndOfInput");
              };
              throw new Error("Failed pattern match at Language.Verne.Parser line 68, column 1 - line 69, column 1: " + [ pos.constructor.name, _13.constructor.name ]);
          };
      };
...
(function(exports) {
  ...
  var prepare = function (_0) {
      if (_0 instanceof Language_Verne_Types.LIST_T && _0.value2 instanceof Data_Maybe.Just) {
          return new Data_Either.Left({
              error: _0.value2.value0, 
              pos: _0.value1
          });
      };
      if (_0 instanceof Language_Verne_Types.LIST_T && _0.value2 instanceof Data_Maybe.Nothing) {
          var _7 = Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Prelude["<$>"](Prelude.functorArray)(prepare)(_0.value3));
      ...
      if (_0 instanceof Language_Verne_Types.ATOM_T && _0.value3 instanceof Data_Either.Left) {
          return new Data_Either.Left({
              error: _0.value3.value0, 
              pos: _0.value1
          });
      };
      if (_0 instanceof Language_Verne_Types.ATOM_T && _0.value3 instanceof Data_Either.Right) {
          return new Data_Either.Right(Data_Foreign.toForeign({
              atom: _0.value3.value0
          }));
      };
      throw new Error("Failed pattern match: " + [ _0.constructor.name ]);
  };
...
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var $foreign = PS["Language.Verne.TypeChecker"];
  var Prelude = PS["Prelude"];
                  ...
                  return function (sig) {
                      return function (value) {
                          return {
                              name: name, 
                              signature: sig, 
                              original: $foreign.toComponentOriginal(value)
                          };
                      };
                  };
              };
