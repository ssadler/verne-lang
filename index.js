...
(function(exports) {
  ...
  var hashString = new Hashable(Language_Verne_Utils.hashOne);
...
})(PS["Language.Verne.Types.Hashable"] = PS["Language.Verne.Types.Hashable"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Data_Foreign = PS["Data.Foreign"];
  ...
  var Data_Foreign_NullOrUndefined = PS["Data.Foreign.NullOrUndefined"];
  var Data_Maybe = PS["Data.Maybe"];
  var Language_Verne_Types_Core = PS["Language.Verne.Types.Core"];
  var Language_Verne_Types_Hashable = PS["Language.Verne.Types.Hashable"];
  var Language_Verne_Utils = PS["Language.Verne.Utils"];
  var Prelude = PS["Prelude"];
  var Data_Either = PS["Data.Either"];
  var Data_Foreign_Index = PS["Data.Foreign.Index"];     
  ...
  var valueComponent = function (__dict_Hashable_0) {
      return function (sig) {
          return function (value) {
              return {
                  id: Language_Verne_Types_Hashable.hash(__dict_Hashable_0)(value), 
                  name: "Anon", 
                  signature: sig, 
                  exec: Data_Foreign.toForeign(function (_4) {
                      return value;
                  }), 
  ...
  var showComponent = new Prelude.Show(function (_5) {
      var f = Prelude["<$>"](Data_Maybe.functorMaybe)(Language_Verne_Utils.dump)(_5.autocomplete);
      var e = Language_Verne_Utils.dump(_5.exec);
      return "Component {" + (_5.id + ("," + (_5.name + ("," + (Prelude.show(Prelude.showArray(Prelude.showString))(_5.signature) + ("," + (Prelude.show(Data_Maybe.showMaybe(Prelude.showString))(f) + ("," + (Language_Verne_Utils.dump(_5.exec) + "}")))))))));
  });
  var eqComponent = new Prelude.Eq(function (_6) {
      return function (_7) {
          return Prelude["=="](Prelude.eqString)(_6.id)(_7.id);
      };
  });
...
})(PS["Language.Verne.Types.Component"] = PS["Language.Verne.Types.Component"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Data_Generic = PS["Data.Generic"];
  ...
  var Language_Verne_Types_Component = PS["Language.Verne.Types.Component"];
  var Language_Verne_Types_Core = PS["Language.Verne.Types.Core"];
  var Language_Verne_Types_Hashable = PS["Language.Verne.Types.Hashable"];
  var Language_Verne_Utils = PS["Language.Verne.Utils"];     
  var Pos = function (x) {
  ...
  var genericPos = new Data_Generic.Generic(function ($dollarx) {
      if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.Types.Pos" && $dollarx.value1.length === 1)) {
          return Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Pos))((function (r) {
              if (r instanceof Data_Generic.SRecord && r.value0.length === 2) {
                  return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(function (a_1) {
                      return function (b_1) {
                          return {
                              a: a_1, 
                              b: b_1
      ...
      return new Data_Generic.SProd("Language.Verne.Types.Pos", [ function ($dollarq) {
          return new Data_Generic.SRecord([ {
              ...
              recValue: function ($dollarq_1) {
                  return Data_Generic.toSpine(Data_Generic.genericInt)($dollarx.a);
              }
          }, {
              recLabel: "b", 
              recValue: function ($dollarq_1) {
                  return Data_Generic.toSpine(Data_Generic.genericInt)($dollarx.b);
              }
          } ]);
      } ]);
  });
...
(function(exports) {
  ...
  var addComponent$prime = function (name) {
      return function (_2) {
          return function (_3) {
              var _15 = Data_Map.member(Prelude.ordString)(name)(_3.value0);
              if (_15) {
              ...
              if (!_15) {
                  ...
                  return new Data_Either.Right(new Namespace(Data_Map.insert(Prelude.ordString)(name)(_2)(_3.value0), union));
              };
              throw new Error("Failed pattern match at Language.Verne.Namespace line 40, column 1 - line 41, column 1: " + [ _15.constructor.name ]);
          };
      };
  };
  var addComponent = function (fo) {
      return function (ns) {
          var ef = Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(addComponent$prime)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("name")(fo)))(Data_Foreign_Class.read(Language_Verne_Types_Component.componentIsForeign)(fo));
          if (ef instanceof Data_Either.Left) {
              return new Data_Either.Left("Error importing component: " + Prelude.show(Data_Foreign.showForeignError)(ef.value0));
          };
          if (ef instanceof Data_Either.Right) {
              return ef.value0(ns);
          };
          throw new Error("Failed pattern match at Language.Verne.Namespace line 32, column 1 - line 33, column 1: " + [ ef.constructor.name ]);
      };
  };
...
(function(exports) {
              ...
              var strConstruct = function (typ) {
                  return function (str) {
                      return Prelude[">>="](Data_Maybe.bindMaybe)(Language_Verne_Namespace.componentByName(typ)(ns))(function (_0) {
                          var _6 = Prelude["=="](Prelude.eqArray(Prelude.eqString))(_0.signature)([ typ, "String" ]);
                          if (_6) {
                              return new Data_Maybe.Just(Language_Verne_Types_Component.valueComponent(Language_Verne_Types_Hashable.hashString)([ typ ])(str));
                          };
                          if (!_6) {
                              return Data_Maybe.Nothing.value;
                          };
                          throw new Error("Failed pattern match at Language.Verne.TypeChecker line 71, column 5 - line 74, column 5: " + [ _6.constructor.name ]);
                      });
                  };
              };
              ...
              var anno = function (typ) {
                  return function (_1) {
                      if (_1 instanceof Language_Verne_Types.LIST) {
                          var _9 = Data_Array.uncons(_1.value1);
                          ...
                          if (_9 instanceof Data_Maybe.Just) {
                              var typePadding = Data_Array.replicate(Data_Array.length(_9.value0.tail))("");
                              var atom = anno(typ)(_9.value0.head);
                              if (atom instanceof ATOM_T && atom.value0.ecomp instanceof Data_Either.Left) {
                                  return new LIST_T({
                                      typ: typ, 
                                      pos: _1.value0, 
                                      merr: new Data_Maybe.Just(atom.value0.ecomp.value0), 
                                      arr: Data_Array[":"](atom)(Data_Array.zipWith(anno)(typePadding)(_9.value0.tail))
                                  });
                              };
                              if (atom instanceof ATOM_T && atom.value0.ecomp instanceof Data_Either.Right) {
                                  var _14 = Data_Array.length(atom.value0.ecomp.value0.signature) - 1 === Data_Array.length(_9.value0.tail);
                                  if (_14) {
                                      ...
                                      return new LIST_T({
                                          ...
                                          arr: Data_Array[":"](atom)(Data_Array.zipWith(anno)(sig)(_9.value0.tail))
                                      });
                                  };
                                  if (!_14) {
                                  ...
                                  throw new Error("Failed pattern match at Language.Verne.TypeChecker line 32, column 1 - line 33, column 1: " + [ _14.constructor.name ]);
                              };
                          ...
                          throw new Error("Failed pattern match at Language.Verne.TypeChecker line 32, column 1 - line 33, column 1: " + [ _9.constructor.name ]);
                      };
                      if (_1 instanceof Language_Verne_Types.ATOM && _1.value1 instanceof Language_Verne_Types.Name) {
                          var ecomp = (function () {
                              var _23 = Language_Verne_Namespace.componentByName(_1.value1.value0)(ns);
                              ...
                              if (_23 instanceof Data_Maybe.Just) {
                                  var _24 = Data_Array.head(_23.value0.signature);
                                  if (_24 instanceof Data_Maybe.Just) {
                                      var _25 = Prelude["=="](Prelude.eqString)(_24.value0)(typ);
                                      if (_25) {
                                          return Data_Either.Right.create(_23.value0);
                                      };
                                      if (!_25) {
                                          return errExpected(typ)(_24.value0);
                                      };
                                  ...
                                  throw new Error("Failed pattern match at Language.Verne.TypeChecker line 53, column 13 - line 60, column 9: " + [ _24.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Language.Verne.TypeChecker line 53, column 13 - line 60, column 9: " + [ _23.constructor.name ]);
                          })();
                          return new ATOM_T({
                              typ: typ, 
                              pos: _1.value0, 
                      ...
                      if (_1 instanceof Language_Verne_Types.ATOM && _1.value1 instanceof Language_Verne_Types.Str) {
                          var ecomp = (function () {
                              var _31 = Prelude["=="](Prelude.eqString)(typ)("String");
                              if (_31) {
                                  return Data_Either.Right.create(Language_Verne_Types_Component.valueComponent(Language_Verne_Types_Hashable.hashString)([ "String" ])(_1.value1.value0));
                              };
                              if (!_31) {
                                  var _32 = strConstruct(typ)(_1.value1.value0);
                                  if (_32 instanceof Data_Maybe.Nothing) {
                                      return errExpected(typ)("String");
                                  };
                                  if (_32 instanceof Data_Maybe.Just) {
                                      return new Data_Either.Right(_32.value0);
                                  };
                                  throw new Error("Failed pattern match: " + [ _32.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Language.Verne.TypeChecker line 63, column 13 - line 68, column 10: " + [ _31.constructor.name ]);
                          })();
                          return new ATOM_T({
                              typ: typ, 
                              pos: _1.value0, 
                      ...
                      throw new Error("Failed pattern match at Language.Verne.TypeChecker line 32, column 1 - line 33, column 1: " + [ typ.constructor.name, _1.constructor.name ]);
                  };
              };
  ...
  var showLISP_T = new Prelude.Show(function (_4) {
      if (_4 instanceof LIST_T) {
          return "LIST_T {" + (_4.value0.typ + ("," + (Prelude.show(Language_Verne_Types.showPos)(_4.value0.pos) + ("," + (Prelude.show(Data_Maybe.showMaybe(Prelude.showString))(_4.value0.merr) + ("," + (Prelude.show(Prelude.showArray(showLISP_T))(_4.value0.arr) + "}")))))));
      };
      if (_4 instanceof ATOM_T) {
          return "ATOM_T {" + (_4.value0.typ + ("," + (Prelude.show(Language_Verne_Types.showPos)(_4.value0.pos) + ("," + (Prelude.show(Language_Verne_Types.showAtom)(_4.value0.atom) + ("," + (Prelude.show(Data_Either.showEither(Prelude.showString)(Language_Verne_Types_Component.showComponent))(_4.value0.ecomp) + "}")))))));
      };
      throw new Error("Failed pattern match: " + [ _4.constructor.name ]);
  });
  var eqLISP_T = new Prelude.Eq(function (_2) {
      return function (_3) {
          if (_2 instanceof LIST_T && _3 instanceof LIST_T) {
              return Prelude["=="](Prelude.eqString)(_2.value0.typ)(_3.value0.typ) && (Prelude["=="](Language_Verne_Types.eqPos)(_2.value0.pos)(_3.value0.pos) && (Prelude["=="](Data_Maybe.eqMaybe(Prelude.eqString))(_2.value0.merr)(_3.value0.merr) && Prelude["=="](Prelude.eqArray(eqLISP_T))(_2.value0.arr)(_3.value0.arr)));
          };
          if (_2 instanceof ATOM_T && _3 instanceof ATOM_T) {
              return Prelude["=="](Prelude.eqString)(_2.value0.typ)(_3.value0.typ) && (Prelude["=="](Language_Verne_Types.eqPos)(_2.value0.pos)(_3.value0.pos) && (Prelude["=="](Language_Verne_Types.eqAtom)(_2.value0.atom)(_3.value0.atom) && Prelude["=="](Data_Either.eqEither(Prelude.eqString)(Language_Verne_Types_Component.eqComponent))(_2.value0.ecomp)(_3.value0.ecomp)));
          };
          if (_2 instanceof LIST_T && _3 instanceof ATOM_T) {
              return false;
          };
          if (_2 instanceof ATOM_T && _3 instanceof LIST_T) {
              return false;
          };
          throw new Error("Failed pattern match: " + [ _2.constructor.name, _3.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var onLeft = function (f) {
      return function (a) {
          return Control_Monad_Except.except((function () {
              var _5 = Control_Monad_Except.runExcept(a);
              if (_5 instanceof Data_Either.Left) {
                  return new Data_Either.Left(f(_5.value0));
              };
              return _5;
          })());
      };
  ...
  var componentAutocomplete = function (r) {
      return function (_2) {
          if (_2.autocomplete instanceof Data_Maybe.Nothing) {
  ...
  var completionWidget = function (r) {
      return function (name) {
          return Data_Maybe.maybe(Prelude["return"](Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.applicativeIdentity))(Prelude.unit))(componentAutocomplete(r))(Language_Verne_Namespace.componentByName(name)(r.ns));
      };
  };
  var findCompletions = function (r) {
      return function (prefix) {
          return function (typ) {
              var lpref = Data_String.toLower(prefix);
              var hasPrefix = function (_4) {
                  return Prelude["=="](Data_Maybe.eqMaybe(Prelude.eqInt))(Data_String.indexOf(lpref)(Data_String.toLower(_4.name)))(new Data_Maybe.Just(0));
              };
              var comps = Language_Verne_Namespace.componentsByTypeHead(typ)(r.ns);
              var matches = Data_Array.filter(hasPrefix)(comps);
              return complete(result(getPos(r.lisp))(new NameCompletions(matches)));
          };
      };
  };
  var completeNextArg = function (r) {
      return function (arr) {
  ...
  var findCompletion$prime = function (r) {
      if (r.lisp instanceof Language_Verne_TypeChecker.LIST_T) {
          return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Control_Monad.when(Control_Monad_Except_Trans.monadExceptT(Data_Identity.monadIdentity))(Data_Array.length(r.lisp.value0.arr) === 0)(findCompletions(r)("")(r.lisp.value0.typ)))(function () {
              return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.applicativeIdentity))(function (l) {
                  return findCompletion((function () {
                      var _29 = {};
                      for (var _30 in r) {
                          if (r.hasOwnProperty(_30)) {
                              _29[_30] = r[_30];
                          };
                      };
                      _29.lisp = l;
              ...
              })(r.lisp.value0.arr))(function () {
                  return completeNextArg(r)(r.lisp.value0.arr);
              });
          });
      };
      ...
      if (r.lisp instanceof Language_Verne_TypeChecker.ATOM_T && r.lisp.value0.ecomp instanceof Data_Either.Left) {
          return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))((function () {
              ...
              return complete(result(r.lisp.value0.pos)(new ShowError(r.lisp.value0.ecomp.value0)));
          });
      };
      throw new Error("Failed pattern match: " + [ r.lisp.constructor.name ]);
  };
  var findCompletion = function (r) {
      var pos = (function () {
          var _49 = getPos(r.lisp);
          return _49;
      })();
      return Control_Monad.when(Control_Monad_Except_Trans.monadExceptT(Data_Identity.monadIdentity))(r.caret >= pos.a && r.caret <= pos.b)(findCompletion$prime(r));
  };
  var getCompletion = function (ns) {
      return function (caret) {
          return function (lisp) {
              return Data_Either.either(Data_Maybe.Just.create)(function (_1) {
                  return Data_Maybe.Nothing.value;
              })(Control_Monad_Except.runExcept(findCompletion({
                  lisp: lisp, 
                  ns: ns, 
                  caret: caret
              })));
...
})(PS["Language.Verne.Completions"] = PS["Language.Verne.Completions"] || {});
(function(exports) {
  // Generated by psc version 0.7.6.1
  "use strict";
  var Prelude = PS["Prelude"];
...
(function(exports) {
      ...
      return Prelude.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_String["char"]("\""))(function () {
          return Prelude.bind(Text_Parsing_StringParser.bindParser)(Text_Parsing_StringParser_Combinators.many(Text_Parsing_StringParser_String.satisfy(function (_48) {
              ...
              return Prelude.bind(Text_Parsing_StringParser.bindParser)(Control_Alt["<|>"](Text_Parsing_StringParser.altParser)(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_String.eof)(Prelude.pure(Text_Parsing_StringParser.applicativeParser)(maxpos)))(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_String["char"]("\""))(getPos)))(function (_6) {
                  ...
                  return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(new Language_Verne_Types.ATOM(pos, new Language_Verne_Types.Str(Data_String.fromCharArray(Data_List.fromList(Data_Unfoldable.unfoldableArray)(_7)))));
              });
          });
      });
  });
      ...
      return Prelude.bind(Text_Parsing_StringParser.bindParser)(getPos)(function (_11) {
          return Prelude.bind(Text_Parsing_StringParser.bindParser)(p)(function (_10) {
              return Prelude.bind(Text_Parsing_StringParser.bindParser)(getPos)(function (_9) {
                  return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(_10({
                      a: _11, 
                      b: _9
                  }));
              });
          ...
          return Prelude.bind(Text_Parsing_StringParser.bindParser)(getPos)(function (_3) {
              return Prelude.bind(Text_Parsing_StringParser.bindParser)(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_String["char"]("("))(Text_Parsing_StringParser_String.skipSpaces))(parseArgs))(function (_2) {
                  return Prelude.bind(Text_Parsing_StringParser.bindParser)(Control_Alt["<|>"](Text_Parsing_StringParser.altParser)(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_String.eof)(Prelude.pure(Text_Parsing_StringParser.applicativeParser)(maxpos)))(Control_Apply["*>"](Text_Parsing_StringParser.applyParser)(Text_Parsing_StringParser_String["char"](")"))(getPos)))(function (_1) {
                      return Prelude.pure(Text_Parsing_StringParser.applicativeParser)(new Language_Verne_Types.LIST({
                          a: _3, 
                          b: _1
                      }, _2));
                  });
          ...
          var dive = function (__copy__18) {
              ...
              tco: while (true) {
                  if (_18 instanceof Language_Verne_Types.LIST) {
                      ...
                      throw new Error("Failed pattern match at Language.Verne.Parser line 78, column 1 - line 79, column 1: " + [ _36.constructor.name ]);
                  };
                  ...
                  throw new Error("Failed pattern match at Language.Verne.Parser line 78, column 1 - line 79, column 1: " + [ _18.constructor.name ]);
              };
          };
          return dive(a);
      };
  ...
  var parse = function (input) {
      ...
      var parseCode = Prelude["<*>"](Text_Parsing_StringParser.applyParser)(Prelude["<$>"](Text_Parsing_StringParser.functorParser)(Language_Verne_Types.LIST.create)(thePos))(parseArgs);
      var onErr = function (pos) {
          return function (_17) {
              ...
              throw new Error("Failed pattern match at Language.Verne.Parser line 69, column 1 - line 70, column 1: " + [ pos.constructor.name, _17.constructor.name ]);
          };
      };
