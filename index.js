...
(function(exports) {
  ...
  var genericParseResult = function (__dict_Generic_6) {
      return new Data_Generic.Generic(function ($dollarx) {
          ...
          throw new Error("Failed pattern match at Language.Verne.Types line 52, column 1 - line 53, column 1: " + [ $dollarx.constructor.name ]);
      });
  };
  ...
  var genericAtom = new Data_Generic.Generic(function ($dollarx) {
      ...
      throw new Error("Failed pattern match at Language.Verne.Types line 46, column 1 - line 47, column 1: " + [ $dollarx.constructor.name ]);
  });
...
(function(exports) {
              ...
              var strConstruct = function (typ) {
                  return function (str) {
                      return Prelude[">>="](Data_Maybe.bindMaybe)(Language_Verne_Namespace.componentByName(typ)(ns))(function (_0) {
                          var _7 = Prelude["=="](Prelude.eqArray(Prelude.eqString))(_0.signature)([ typ, "String" ]);
                          if (_7) {
                          ...
                          throw new Error("Failed pattern match at Language.Verne.TypeChecker line 31, column 1 - line 32, column 1: " + [ _7.constructor.name ]);
                      });
                  };
              };
              ...
              var anno = function (typ) {
                  return function (_1) {
                      if (_1 instanceof Language_Verne_Types.LIST) {
                          var _10 = Data_Array.uncons(_1.value1);
                          ...
                          if (_10 instanceof Data_Maybe.Just) {
                              var typePadding = Data_Array.replicate(Data_Array.length(_10.value0.tail))("");
                              var atom = anno(typ)(_10.value0.head);
                              if (atom instanceof ATOM_T && atom.value0.ecomp instanceof Data_Either.Left) {
                                  return new LIST_T({
                                      typ: typ, 
                                      pos: _1.value0, 
                                      merr: new Data_Maybe.Just(atom.value0.ecomp.value0), 
                                      arr: Data_Array[":"](atom)(Data_Array.zipWith(anno)(typePadding)(_10.value0.tail))
                                  });
                              };
                              if (atom instanceof ATOM_T && atom.value0.ecomp instanceof Data_Either.Right) {
                                  var _15 = Data_Array.length(atom.value0.ecomp.value0.signature) - 1 === Data_Array.length(_10.value0.tail);
                                  if (_15) {
                                      ...
                                      return new LIST_T({
                                          ...
                                          arr: Data_Array[":"](atom)(Data_Array.zipWith(anno)(sig)(_10.value0.tail))
                                      });
                                  };
                                  if (!_15) {
                                  ...
                                  throw new Error("Failed pattern match at Language.Verne.TypeChecker line 31, column 1 - line 32, column 1: " + [ _15.constructor.name ]);
                              };
                          ...
                          throw new Error("Failed pattern match at Language.Verne.TypeChecker line 31, column 1 - line 32, column 1: " + [ _10.constructor.name ]);
                      };
                      if (_1 instanceof Language_Verne_Types.ATOM && _1.value1 instanceof Language_Verne_Types.Name) {
                          var ecomp = (function () {
                              ...
                              throw new Error("Failed pattern match at Language.Verne.TypeChecker line 52, column 13 - line 59, column 9: " + [ _24.constructor.name ]);
                          })();
                          return new ATOM_T({
                              typ: typ, 
                              pos: _1.value0, 
                      ...
                      if (_1 instanceof Language_Verne_Types.ATOM && _1.value1 instanceof Language_Verne_Types.Str) {
                          var ecomp = (function () {
                              ...
                              throw new Error("Failed pattern match at Language.Verne.TypeChecker line 63, column 13 - line 68, column 10: " + [ _32.constructor.name ]);
                          })();
                          return new ATOM_T({
                              typ: typ, 
                              pos: _1.value0, 
                      ...
                      throw new Error("Failed pattern match at Language.Verne.TypeChecker line 31, column 1 - line 32, column 1: " + [ typ.constructor.name, _1.constructor.name ]);
                  };
              };
  ...
  var genericLISP_T = function (__dict_Generic_2) {
      return new Data_Generic.Generic(function ($dollarx) {
          if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.TypeChecker.LIST_T" && $dollarx.value1.length === 1)) {
              return Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(LIST_T.create))((function (r) {
                  if (r instanceof Data_Generic.SRecord && r.value0.length === 4) {
                      return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(function (arr_1) {
                          return function (merr_1) {
                              return function (pos_1) {
                                  return function (typ_1) {
                                      return {
                                          arr: arr_1, 
                                          merr: merr_1, 
                                          pos: pos_1, 
                      ...
                      }))(Data_Generic.fromSpine(Data_Generic.genericArray(genericLISP_T(__dict_Generic_2)))((r.value0[0]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericMaybe(Data_Generic.genericString))((r.value0[1]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Language_Verne_Types.genericPos)((r.value0[2]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericString)((r.value0[3]).recValue(Prelude.unit)));
                  };
                  return Data_Maybe.Nothing.value;
              })($dollarx.value1[0](Prelude.unit)));
          };
          if ($dollarx instanceof Data_Generic.SProd && ($dollarx.value0 === "Language.Verne.TypeChecker.ATOM_T" && $dollarx.value1.length === 1)) {
              return Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(ATOM_T.create))((function (r) {
                  if (r instanceof Data_Generic.SRecord && r.value0.length === 4) {
                      return Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(Prelude.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(function (atom_1) {
                          return function (ecomp_1) {
                              return function (pos_1) {
                                  return function (typ_1) {
                                      return {
                                          atom: atom_1, 
                      ...
                      }))(Data_Generic.fromSpine(__dict_Generic_2)((r.value0[0]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericEither(Data_Generic.genericString)(Language_Verne_Types.genericComponent))((r.value0[1]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Language_Verne_Types.genericPos)((r.value0[2]).recValue(Prelude.unit))))(Data_Generic.fromSpine(Data_Generic.genericString)((r.value0[3]).recValue(Prelude.unit)));
                  };
                  return Data_Maybe.Nothing.value;
              })($dollarx.value1[0](Prelude.unit)));
          };
          ...
          return new Data_Generic.SigProd("Language.Verne.TypeChecker.LISP_T", [ {
              sigConstructor: "Language.Verne.TypeChecker.LIST_T", 
              sigValues: [ function ($dollarq_1) {
                  return new Data_Generic.SigRecord([ {
                      recLabel: "arr", 
                      recValue: function ($dollarq_2) {
                          return Data_Generic.toSignature(Data_Generic.genericArray(genericLISP_T(__dict_Generic_2)))(Data_Generic.anyProxy);
                      }
                  }, {
                      recLabel: "merr", 
                      recValue: function ($dollarq_2) {
                      ...
                      recLabel: "pos", 
                      recValue: function ($dollarq_2) {
                          return Data_Generic.toSignature(Language_Verne_Types.genericPos)(Data_Generic.anyProxy);
                      }
                  }, {
                      recLabel: "typ", 
                      recValue: function ($dollarq_2) {
              ...
              sigConstructor: "Language.Verne.TypeChecker.ATOM_T", 
              sigValues: [ function ($dollarq_1) {
                  return new Data_Generic.SigRecord([ {
                      recLabel: "atom", 
                      recValue: function ($dollarq_2) {
                      ...
                      recLabel: "ecomp", 
                      recValue: function ($dollarq_2) {
                          return Data_Generic.toSignature(Data_Generic.genericEither(Data_Generic.genericString)(Language_Verne_Types.genericComponent))(Data_Generic.anyProxy);
                      }
                  }, {
                      recLabel: "pos", 
                      recValue: function ($dollarq_2) {
          ...
          if ($dollarx instanceof LIST_T) {
              return new Data_Generic.SProd("Language.Verne.TypeChecker.LIST_T", [ function ($dollarq) {
                  return new Data_Generic.SRecord([ {
                      recLabel: "arr", 
                      recValue: function ($dollarq_1) {
                          return Data_Generic.toSpine(Data_Generic.genericArray(genericLISP_T(__dict_Generic_2)))($dollarx.value0.arr);
                      }
                  }, {
                      recLabel: "merr", 
                      recValue: function ($dollarq_1) {
                          return Data_Generic.toSpine(Data_Generic.genericMaybe(Data_Generic.genericString))($dollarx.value0.merr);
                      }
                  }, {
                      recLabel: "pos", 
                      recValue: function ($dollarq_1) {
                          return Data_Generic.toSpine(Language_Verne_Types.genericPos)($dollarx.value0.pos);
                      }
                  }, {
                      recLabel: "typ", 
                      recValue: function ($dollarq_1) {
                          return Data_Generic.toSpine(Data_Generic.genericString)($dollarx.value0.typ);
                      }
                  } ]);
              } ]);
          };
          if ($dollarx instanceof ATOM_T) {
              return new Data_Generic.SProd("Language.Verne.TypeChecker.ATOM_T", [ function ($dollarq) {
                  return new Data_Generic.SRecord([ {
                      recLabel: "atom", 
                      recValue: function ($dollarq_1) {
                          return Data_Generic.toSpine(__dict_Generic_2)($dollarx.value0.atom);
                      }
                  }, {
                      recLabel: "ecomp", 
                      recValue: function ($dollarq_1) {
                          return Data_Generic.toSpine(Data_Generic.genericEither(Data_Generic.genericString)(Language_Verne_Types.genericComponent))($dollarx.value0.ecomp);
                      }
                  }, {
                      recLabel: "pos", 
                      recValue: function ($dollarq_1) {
  ...
  var showLISP_T = function (__dict_Generic_0) {
      return function (__dict_Show_1) {
          return new Prelude.Show(function (_60) {
              return Language_Verne_Utils.compactShow(Data_Generic.gShow(genericLISP_T(__dict_Generic_0))(_60));
          });
      };
  };
  var eqLISP_T = function (__dict_Generic_3) {
      return function (__dict_Eq_4) {
          return new Prelude.Eq(Data_Generic.gEq(genericLISP_T(__dict_Generic_3)));
      };
  };
