...
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var $foreign = PS["Verne.Data.Namespace"];
  var Data_List = PS["Data.List"];
  var Data_Foreign = PS["Data.Foreign"];
  var Data_Maybe = PS["Data.Maybe"];
  var Data_String = PS["Data.String"];
  ...
  var Verne_Types_Hashable = PS["Verne.Types.Hashable"];
  var Prelude = PS["Prelude"];     
  var lookupName = Data_StrMap.lookup;
  var cantResolve = function (name) {
      return {
          id: Verne_Types_Hashable.hash(Verne_Types_Hashable.hashArray(Verne_Types_Hashable.hashString))([ "Can't resolve", name ]), 
          name: "", 
          signature: [ "" ], 
          exec: Data_Foreign.toForeign(function (a) {
              return a;
          }), 
          autocomplete: new Data_Maybe.Just(Data_Foreign.toForeign($foreign.nameCompletion))
      };
  };
  var resolveName = function (name) {
      return function (ns) {
          var $0 = lookupName(name)(ns);
          if ($0 instanceof Data_Maybe.Just) {
              return $0.value0;
          };
          if ($0 instanceof Data_Maybe.Nothing) {
              return cantResolve(name);
          };
          throw new Error("Failed pattern match at Verne.Data.Namespace line 37, column 1 - line 38, column 1: " + [ $0.constructor.name ]);
      };
  };
  var nameComponent = function (name) {
      return {
          ...
          name: name, 
          signature: [ "_lookup" ], 
          exec: Data_Foreign.toForeign(resolveName(name)), 
          autocomplete: Data_Maybe.Nothing.value
      };
  };
  exports["nameComponent"] = nameComponent;
  exports["lookupName"] = lookupName;
  exports["nameCompletion"] = $foreign.nameCompletion;;
...
(function(exports) {
  ...
  var fAT = function (dictFunctor) {
      return new Prelude.Functor(function (f) {
          return mapCoT(Prelude["<$>"](dictFunctor)(Prelude["<$>"](fA(dictFunctor))(f)));
      });
  };
...
(function(exports) {
  ...
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var Control_Monad_Trans = PS["Control.Monad.Trans"];     
  var provideCompletion = function (v) {
      if (v.autocomplete instanceof Data_Maybe.Just) {
          return Verne_Program_Compiler_Coroutine["yield"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(new Data_Either.Right(v));
      };
  ...
  var getPos = function (v) {
      ...
      throw new Error("Failed pattern match at Verne.Program.Compiler line 47, column 1 - line 48, column 1: " + [ v.constructor.name ]);
  };
  var curry = function (v) {
      return function (v1) {
          return Prelude["<$>"](Verne_Program_Compiler_Coroutine.fAT(Control_Monad_State_Trans.functorStateT(Data_Identity.monadIdentity)))(Verne_Data_Component.Component)(Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Monad.when(Verne_Program_Compiler_Coroutine.mA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Prelude["/="](Prelude.eqArray(Prelude.eqString))(Data_Array.take(1)(v.signature))(v1.signature))(Verne_Program_Compiler_Coroutine["yield"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(new Data_Either.Left("curry mismatch"))))(function () {
              return Prelude.pure(Verne_Program_Compiler_Coroutine.cA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))({
                  id: Verne_Utils.hashMany([ v.id, v1.id ]), 
                  name: "", 
                  signature: Data_Array.drop(1)(v.signature), 
                  exec: Verne_Utils.curryForeign(v.exec)(v1.exec), 
                  autocomplete: Prelude["<$>"](Data_Maybe.functorMaybe)(Verne_Utils.autoCurry(v1.exec))(v.autocomplete)
              });
          }));
      };
  };
  var cantResolve = function (name) {
      return {
          ...
          autocomplete: new Data_Maybe.Just(Data_Foreign.toForeign(Verne_Data_Namespace.nameCompletion))
      };
  };
  var resolve = function (v) {
      if (v.signature.length === 1 && v.signature[0] === "_lookup") {
          return Prelude.bind(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Prelude["<#>"](Control_Monad_State_Trans.functorStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity)))(function (v1) {
              return v1.globals;
          }))(function (v1) {
              return Prelude.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Maybe.maybe(cantResolve(v.name))(Prelude.id(Prelude.categoryFn))(Data_StrMap.lookup(v.name)(v1)));
          });
      };
      return Prelude.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(v);
  };
  var go = function (caret) {
      return function (v) {
          if (v instanceof Verne_Data_Code.Atom) {
              return Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Monad_Trans.lift(Verne_Program_Compiler_Coroutine.fMT)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(resolve(v.value0.component)))(function (v1) {
                  return Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Monad.when(Verne_Program_Compiler_Coroutine.mA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(caret >= v.value0.pos.a && caret <= v.value0.pos.b)(provideCompletion(v1)))(function () {
          ...
          if (v instanceof Verne_Data_Code.List) {
              return Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(go(caret)(v.value0.head))(function (v1) {
                  return Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Verne_Program_Compiler_Coroutine.cA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(go(caret))(v.value0.args))(function (v2) {
                      return Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Array.foldM(Verne_Program_Compiler_Coroutine.mA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(curry)(v1)(v2))(function (v3) {
                          return Prelude.bind(Verne_Program_Compiler_Coroutine.bA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))((function () {
                              var $38 = Prelude["<$>"](Data_Maybe.functorMaybe)(getPos)(Data_Array.last(v.value0.args));
                              if ($38 instanceof Data_Maybe.Just && caret > ($38.value0.b + 1 | 0)) {
                                  return provideCompletion(v3);
                              };
                              throw new Error("Failed pattern match: " + [ $38.constructor.name ]);
                          })())(function () {
                              return Prelude.pure(Verne_Program_Compiler_Coroutine.cA(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(v3);
                          });
                      });
                  });
              });
          };
          throw new Error("Failed pattern match: " + [ caret.constructor.name, v.constructor.name ]);
      };
  };
  var compile = function (caret) {
      return function ($44) {
          return Verne_Program_Compiler_Coroutine.runCoT(go(caret)($44));
      };
  };
