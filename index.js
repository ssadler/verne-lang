...
(function(exports) {
  ...
  var showComponent = new Prelude.Show(function (_4) {
      var f = Prelude["<$>"](Data_Maybe.functorMaybe)(function (_3) {
          return "f()";
      })(_4.autocomplete);
      return "Component {" + (_4.name + ("," + (Prelude.show(Prelude.showArray(Prelude.showString))(_4.signature) + ("," + (Prelude.show(Data_Maybe.showMaybe(Prelude.showString))(f) + "}")))));
  });
  ...
  var eqComponent = new Prelude.Eq(function (_5) {
      return function (_6) {
          return Prelude["=="](Prelude.eqString)(_5.name)(_6.name) && (Prelude["=="](Prelude.eqArray(Prelude.eqString))(_5.signature)(_6.signature) && Language_Verne_Utils.isSame(_5.autocomplete)(_6.autocomplete));
      };
  });
              ...
              var strConstruct = function (typ) {
                  return function (str) {
                      return Prelude[">>="](Data_Maybe.bindMaybe)(Language_Verne_Namespace.componentByName(typ)(ns))(function (_0) {
                          ...
                          throw new Error("Failed pattern match at Language.Verne.TypeChecker line 30, column 1 - line 31, column 1: " + [ _6.constructor.name ]);
                      });
                  };
              };
                  ...
                  return function (_1) {
                      if (_1 instanceof Language_Verne_Types.LIST) {
                          ...
                          if (_9 instanceof Data_Maybe.Just) {
                              ...
                              if (atom instanceof ATOM_T && atom.value0.ecomp instanceof Data_Either.Right) {
                                  ...
                                  throw new Error("Failed pattern match at Language.Verne.TypeChecker line 30, column 1 - line 31, column 1: " + [ _14.constructor.name ]);
                              };
                          ...
                          throw new Error("Failed pattern match at Language.Verne.TypeChecker line 30, column 1 - line 31, column 1: " + [ _9.constructor.name ]);
                      };
                      if (_1 instanceof Language_Verne_Types.ATOM && _1.value1 instanceof Language_Verne_Types.Name) {
                          var ecomp = (function () {
                              ...
                              if (_23 instanceof Data_Maybe.Just) {
                                  ...
                                  throw new Error("Failed pattern match at Language.Verne.TypeChecker line 51, column 13 - line 58, column 9: " + [ _24.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Language.Verne.TypeChecker line 51, column 13 - line 58, column 9: " + [ _23.constructor.name ]);
                          })();
                          return new ATOM_T({
                              typ: typ, 
                              pos: _1.value0, 
                      ...
                      if (_1 instanceof Language_Verne_Types.ATOM && _1.value1 instanceof Language_Verne_Types.Str) {
                          var ecomp = (function () {
                              ...
                              throw new Error("Failed pattern match at Language.Verne.TypeChecker line 62, column 13 - line 67, column 10: " + [ _31.constructor.name ]);
                          })();
                          return new ATOM_T({
                              typ: typ, 
                              pos: _1.value0, 
                      ...
                      throw new Error("Failed pattern match at Language.Verne.TypeChecker line 30, column 1 - line 31, column 1: " + [ typ.constructor.name, _1.constructor.name ]);
                  };
              };
  ...
  var showLISP_T = function (__dict_Show_0) {
      return new Prelude.Show(function (_4) {
          if (_4 instanceof LIST_T) {
              return "LIST_T {" + (_4.value0.typ + ("," + (Prelude.show(Language_Verne_Types.showPos)(_4.value0.pos) + ("," + (Prelude.show(Data_Maybe.showMaybe(Prelude.showString))(_4.value0.merr) + ("," + (Prelude.show(Prelude.showArray(showLISP_T(__dict_Show_0)))(_4.value0.arr) + "}")))))));
          };
          if (_4 instanceof ATOM_T) {
              return "ATOM_T {" + (_4.value0.typ + ("," + (Prelude.show(Language_Verne_Types.showPos)(_4.value0.pos) + ("," + (Prelude.show(__dict_Show_0)(_4.value0.atom) + ("," + (Prelude.show(Data_Either.showEither(Prelude.showString)(Language_Verne_Types.showComponent))(_4.value0.ecomp) + "}")))))));
          };
          throw new Error("Failed pattern match: " + [ _4.constructor.name ]);
      });
  };
  var eqLISP_T = function (__dict_Eq_1) {
      return new Prelude.Eq(function (_2) {
          return function (_3) {
              if (_2 instanceof LIST_T && _3 instanceof LIST_T) {
                  return Prelude["=="](Prelude.eqString)(_2.value0.typ)(_3.value0.typ) && (Prelude["=="](Language_Verne_Types.eqPos)(_2.value0.pos)(_3.value0.pos) && (Prelude["=="](Data_Maybe.eqMaybe(Prelude.eqString))(_2.value0.merr)(_3.value0.merr) && Prelude["=="](Prelude.eqArray(eqLISP_T(__dict_Eq_1)))(_2.value0.arr)(_3.value0.arr)));
              };
              if (_2 instanceof ATOM_T && _3 instanceof ATOM_T) {
                  return Prelude["=="](Prelude.eqString)(_2.value0.typ)(_3.value0.typ) && (Prelude["=="](Language_Verne_Types.eqPos)(_2.value0.pos)(_3.value0.pos) && (Prelude["=="](__dict_Eq_1)(_2.value0.atom)(_3.value0.atom) && Prelude["=="](Data_Either.eqEither(Prelude.eqString)(Language_Verne_Types.eqComponent))(_2.value0.ecomp)(_3.value0.ecomp)));
              };
